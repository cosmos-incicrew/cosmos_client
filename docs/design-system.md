...
| primaryDark | #112D55 | 딥 네이비. 헤드라인·로고 텍스트·갈무리 제목 |
...
**포인트 (갈무리) — 3단계로 통일. 화면에서 size 직접 지정 금지, 아래만 사용:**

| 이름 | 크기 | 폰트 | 용도 |
| --- | --- | --- | --- |
| pointLg | 44 | 갈무리11 | 화면 주인공 타이틀 (BSTI 등) |
| pointMd | 30 | 갈무리11 | 섹션 강조 (My skin i-TEM, TEST START) |
| pointSm | 17 | 갈무리9 | 버튼 라벨·작은 포인트 |

기본 색은 딥 네이비(primaryDark). 필요 시 color만 넘긴다.
